...
namespace ArcheAge.ArcheAge.Network
{
    public sealed class NP_CharacterListPacket_0x0039 : NetPacket
    {
        ...
        /// <param name="num">номер героя которого выводим в пакете</param>
        ...
        public NP_CharacterListPacket_0x0039(ClientConnection net, int num, int last) : base(01, 0x0039)
        {
            ...
            foreach (Character chr in charList) //<for id="0">
            {
                ...
                {
                    ns.Write((int)chr.CharacterId); //  "type" type="d"
                    ...
                    ns.Write((long)0x0007045E3D800000); //"x" type="Q"
                    ns.Write((long)0x0021F96715C40000); //"y" type="Q"
                    ns.Write((float)0x42CFA1CB); //"z" type="f"
