...
namespace ArcheAge.ArcheAge.Network
{
    public sealed class NP_DetailedTimeOfDayPacket_0x00EA : NetPacket
    {
        public NP_DetailedTimeOfDayPacket_0x00EA(ClientConnection net) : base(01, 0x00EA)
        {
            ...
            ns.Write((float) DateTime.UtcNow.Hour); //time f (время суток на сервере)(Environment.TickCount & Int32.MaxValue)
            ns.Write((float) 0.001666600001044571399688720703125); //speed f
