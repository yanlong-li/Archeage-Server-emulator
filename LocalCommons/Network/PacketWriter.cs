...
namespace LocalCommons.Network
{
    ...
    public class PacketWriter: IDisposable
    {
        ...
        /// <param name="LittleEndian">пор€док байтов</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// ѕишем массив байт buffer, начина€ со смещени€ offset в этом массива, длиной size
        /// длину не вставл€ем перед массивом
        /// </summary>
        ...
        /// <summary>
        /// ѕишем массив байт buffer, начина€ со смещени€ offset в этом массива, длиной size подсчитанной из размера буфера,
        /// длину size вставл€ем перед массивом
        /// Author: NLObP
        /// </summary>
        /// <param name="buffer">указатель на буфер пакета</param>
        /// <param name="offset">смещение в буфере пакета</param>
        ...
        /// <summary>
        /// «аписываем строку переведенную из шестнадцатеричного текста в байты, длину не записываем спереди
        /// </summary>
        ...
        /// <summary>
        /// «аписываем строку переведенную из шестнадцатеричного текста в байты, длину записываем спереди
        /// длина беретс€ из длины строки
        /// </summary>
        /// <param name="value">строка в виде HEX</param>
        /// <param name="size">параметр не используетс€</param>
        ...
        private bool disposedValue = false; // ƒл€ определени€ избыточных вызовов
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!disposedValue)
            {
                if (disposing)
                {
                    // TODO: освободить управл€емое состо€ние (управл€емые объекты).
                    m_Stream.Dispose();
                }

                // TODO: освободить неуправл€емые ресурсы (неуправл€емые объекты) и переопределить ниже метод завершени€.
                // TODO: задать большим пол€м значение NULL.

                disposedValue = true;
            }
        }

        // TODO: переопределить метод завершени€, только если Dispose(bool disposing) выше включает код дл€ освобождени€ неуправл€емых ресурсов.
        // ~PacketWriter() {
        //   // Ќе измен€йте этот код. –азместите код очистки выше, в методе Dispose(bool disposing).
        //   Dispose(false);
        // }

        // Ётот код добавлен дл€ правильной реализации шаблона высвобождаемого класса.
        public void Dispose()
        {
            // Ќе измен€йте этот код. –азместите код очистки выше, в методе Dispose(bool disposing).
            Dispose(true);
            // TODO: раскомментировать следующую строку, если метод завершени€ переопределен выше.
